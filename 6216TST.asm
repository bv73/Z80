        ORG     #8000
;-----------------------------------
;Test Program For 6216 (537RU10) CMOS-RAM
;(C) By (R)soft 2.4.2000
;BLACK BORDER AFTER TEST - CMOS-RAM OK
;WHITE BORDER AFTER TEST - CMOS-RAM BAD OR FLASH DRIVE DAMAGED
;-------------------------------------
;Port A: Data FLASH
