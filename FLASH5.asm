...
SELFIU  LD      A,(FIRSTN)
        ...
        LD      (FIRSTN),A
        JP      CSELF11
CSELF2  CP      #30             ;F10 - Exit
        JR      NZ,CSELF3
        CALL    INVER_S
        LD      A,(IX+5)
        RET
CSELF3  CP      #39             ;F9 - Lprint
        JR      NZ,CSELF32
        CALL    INVER_S
        CALL    SHOWLPT
        JP      SELFILF
