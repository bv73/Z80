...
; Adding & Test by (R)soft 1998-2000
;-----------------------------------
opcode  EQU     0
secondbyte EQU  0-1
;
...
;
        ...
        ENDMAC
;-------------------------------------------------------------
; Standart Define Symbolical Names Of Internal Ports/Registers
; Symbol "*" as Support Addressing Bits
;-------------------------------------------------------------
P0      EQU     080H    ;* Port 0
SPP     EQU     081H    ;Stack Point Register
DPL     EQU     082H
DPH     EQU     083H
...
SBUF    EQU     099H    ;Serial BUFer
P2      EQU     0A0H    ;* Port 2
IE      EQU     0A8H    ;* Interrupt Enable
P3      EQU     0B0H    ;* Port 3
IP      EQU     0B8H    ;* Interrupt Priority
PSW     EQU     0D0H    ;* Flags Register
ACC     EQU     0E0H    ;* ACCumulator
BREG    EQU     0F0H    ;* B REGisrer
;---------------------------------
; AT89S53 Microcontrollers Extend
;---------------------------------
;DP0L   EQU     082H    ;DPTR0 (Main) Low byte
;DP0H   EQU     083H    ;DPTR0 (Main) High byte
;DP1L   EQU     084H    ;DPTR1 Low byte
;DP1H   EQU     085H    ;DPTR1 High byte
;SPDR   EQU     086H    ;Serial Peripheral interface Data Register
;WMCON  EQU     096H    ;Wait/Memory CONtrol
;SPSR   EQU     0AAH    ;Serial Peripheral interface Status Register
...
;SPCR   EQU     0D5H    ;Serial Pheripheral Control Register
;
;       ORG     #8000
;       .PHASE  0
;------------------------
