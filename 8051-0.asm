...
DPH     EQU     083H    ;DPTR Register (High Byte)
DPL     EQU     082H    ; -- // --     (Low Byte)
P0      EQU     080H    ;Port 0
P1      EQU     090H    ;Port 1
P2      EQU     0A0H    ;Port 2
P3      EQU     0B0H    ;Port 3
